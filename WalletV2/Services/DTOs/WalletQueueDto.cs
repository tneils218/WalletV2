...
public class WalletQueueDto
{
    ...
    private WalletQueueDto(int actionId, int walletId, decimal amount, int sourceId, int destinationId, int destinationWalletId)
    {
        ActionId = actionId;
        WalletId = walletId;
        Amount = amount;
    ...
    private WalletQueueDto(int walletId, decimal amount, int actionId)
    {
        WalletId = walletId;
        Amount = amount;
        ActionId = actionId;
